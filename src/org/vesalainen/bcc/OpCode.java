...
public interface OpCode
{
    ...
    public static final int NOT_IFEQ = IFNE;
    public static final int NOT_IFNE = IFEQ;
    public static final int NOT_IFLT = IFGE;
    public static final int NOT_IFGE = IFLT;
    public static final int NOT_IFGT = IFLE;
    public static final int NOT_IFLE = IFGT;
    public static final int NOT_IF_ICMPEQ = IF_ICMPNE;
    public static final int NOT_IF_ICMPNE = IF_ICMPEQ;
    public static final int NOT_IF_ICMPLT = IF_ICMPGE;
    public static final int NOT_IF_ICMPGE = IF_ICMPLT;
    public static final int NOT_IF_ICMPGT = IF_ICMPLE;
    public static final int NOT_IF_ICMPLE = IF_ICMPGT;
    public static final int NOT_IF_ACMPEQ = IF_ACMPNE;
    public static final int NOT_IF_ACMPNE = IF_ACMPEQ;
    ...
    public static final int NOT_IFNULL = IFNONNULL;
    public static final int NOT_IFNONNULL = IFNULL;
